...
# TODO: Put here your actual creds to make a migration
POSTGRES_USER = os.environ.get('POSTGRES_USER', "postgres_user")
POSTGRES_DB = os.environ.get('POSTGRES_DB', "xml_doc_creator07032025")
POSTGRES_PASSWORD = os.environ.get('POSTGRES_PASSWORD', "HQmZjea9Y7R8JT")
